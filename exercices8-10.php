...
/**
 * Exercice 8:
 * la variable nombres contient un tableau ayant pour valeurs 0, 1, 2 et 3
...
/**
 * Exercice 9:
 * Fusioner la variable $autreNombres de type tableau à la variable $nombres de type tableau à l'aide de la fonction
...
$nombres = array_merge($nombres, $autresNombres);
var_dump($nombres);
/**
 * Exercice 10:
...
echo count($nombres).' éléments'.'<br>';
rsort($nombres);
var_dump($nombres);
?>
</body>
